...
#5、添加 beta 测试开发版trash，想体验新功能或随时跟进更新的可以自行添加测试版：~/.tools/trash/trash_beta.sh
#6、旧版本 trash 为 ~/.tools/trash/trash_no_date.sh ，未添加日期分类和自动删除的版本，喜欢旧版本的可以使用这个版本。
